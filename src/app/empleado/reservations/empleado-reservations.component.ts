...
@Component({
  selector: 'app-empleado-reservations',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './empleado-reservations.component.html',
  styleUrl: './empleado-reservations.component.css'
})
export class EmpleadoReservationsComponent implements OnInit {
  reservas: Reserva[] = [];
  filtroEstado: string = '';
